<div class="sidebar">
    ...
    <div class="side-content">
      ...
      <a title="Pacientes" class="<?php echo ($menuSelected == 'pacientes') ? 'selected' : ''; ?>" href="<?php echo INCLUDE_PATH?>pacientes"><i class="fa-solid fa-clipboard-user"></i> <span>Pacientes</span></a>
      <a title="Remédio" class="<?php echo ($menuSelected == 'remedios') ? 'selected' : ''; ?>" href="<?php echo INCLUDE_PATH?>remedios"><i class="fa-solid fa-pills"></i><span>Remédios</span></a>
