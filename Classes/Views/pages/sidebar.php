<div class="sidebar">
    ...
    <div class="side-content">
      ...
      <a title="Pacientes" class="<?php echo ($menuSelected == 'cadastrar_pacientes') ? 'selected' : ''; ?>" href="<?php echo INCLUDE_PATH?>cadastrar_paciente"><i class="fa-solid fa-user-plus"></i> <span>Cadastrar pacientes</span></a>
      <a title="Remédio" class="<?php echo ($menuSelected == 'comorbidades') ? 'selected' : ''; ?>" href="<?php echo INCLUDE_PATH?>comorbidades"><i class="fa-solid fa-heart-circle-exclamation"></i></i><span>Comorbidades</span></a>
