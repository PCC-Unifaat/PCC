<?php
  $title = 'Editar paciente puericultura';
  $css = ['painel'];
  $js = ['mask','painel','form'];
  include("header.php");
...
<div id="painel">
  ...
  <main id="painel-content">
    <div class="container">
      <div class="content">
        <div class="mapa-site">
          <a href="<?php echo INCLUDE_PATH;?>">Painel / </a> <a href="<?php echo INCLUDE_PATH;?>puericultura">Puerucultura / </a> <span>Editar paciente puericultura</span>
        </div>
        ...
        <form method="post" enctype="multipart/form-data">
            ...
            <div class="form-single w100">
              <label for="observacao">Observação puericultura: </label>
            ...
            <div class="form-single w100">            
              <input type="submit" class="btn-input" name="editar-puericultura" value="Atualizar!">
            </div> 
        </form>
