...
<div id="painel">
  ...
  <main id="painel-content">
    <div class="container">
      <div class="content">
        <div class="mapa-site">
          <a href="<?php echo INCLUDE_PATH;?>">Painel / </a> <a href="<?php echo INCLUDE_PATH;?>criancas">Crianças / </a> <span>Editar criança</span>
        </div>
        ...
        <form method="post" enctype="multipart/form-data">
            ...
            <div class="form-single w100">
              <label for="observacao">Observação criança: </label>
              <input type="text" id="observacao" name="observacao" value="<?php echo $observacao;?>" maxCaracter="60">
            </div>

            <div class="form-single w50">
                <label for="vacina_dengue">Vacina dengue: </label>
                <input type="checkbox" id="vacina_dengue" name="vacina_dengue" value="1" <?php echo (!empty($paciente['vacina_dengue'])) ? 'checked' : ''; ?>>
                <label for="vacina_dengue" class="checkbox-custom"><i class="fa-solid fa-check"></i></label>
            </div>

            <div class="form-single w50">
                <label for="vacina_febre_amarela">Vacina febre amarela: </label>
                <input type="checkbox" id="vacina_febre_amarela" name="vacina_febre_amarela" value="1" <?php echo (!empty($paciente['vacina_febre_amarela'])) ? 'checked' : ''; ?>>
                <label for="vacina_febre_amarela" class="checkbox-custom"><i class="fa-solid fa-check"></i></label>
            </div>
            ...
            <div class="form-single w100">            
              <input type="submit" class="btn-input" name="editar-crianca" value="Atualizar!">
            </div> 
        </form>
