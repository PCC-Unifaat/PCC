...
<div id="painel">
  ...
  <main id="painel-content">
    <div class="container">
      <div class="content">
        <div class="mapa-site">
          <a href="<?php echo INCLUDE_PATH;?>">Painel / </a> <a href="<?php echo INCLUDE_PATH;?>pacientes">Pacientes /</a> <span>Hipertensos</span>
        </div>
      ...
      <div class="legenda-container">
          ...
          <div class="exportar w50">
            <a href="<?php echo INCLUDE_PATH?>hipertensos?exportar" class="btn-input" target="_blank">Exportar tabela</a>
          </div>
        </div>
      </div>
    </div>
