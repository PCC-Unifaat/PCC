<?php
  $title = 'Editar paciente hipertenso';
  $css = ['painel'];
  $js = ['mask','painel','form'];
  include("header.php");
  ...
  $observacao = explode('||', $paciente['observacao'])[3]; //Observação hipertenso
...
<div id="painel">
  ...
  <main id="painel-content">
    <div class="container">
      <div class="content">
        <div class="mapa-site">
          <a href="<?php echo INCLUDE_PATH;?>">Painel / </a> <a href="<?php echo INCLUDE_PATH;?>hipertensos">Hipertensos / </a> <span>Editar paciente hipertenso</span>
        </div>
        ...
        <form method="post" enctype="multipart/form-data">
            ...
            <div class="form-single w100">
              <label for="observacao">Observação hipertenso: </label>
            ...
            <div class="form-single w100">            
              <input type="submit" class="btn-input" name="editar-hipertenso" value="Atualizar!">
            </div> 
        </form>
