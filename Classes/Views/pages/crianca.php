      ...
      <div class="overflow"> 
          ...
          ?>
                <tr>
                  ...
                  <td><span class="<?php echo (!empty($value['vacina_dengue']) ? 'ativo' : '') ?>"><i class="fa-solid fa-syringe"></i></span></td>
                  <td><span class="<?php echo (!empty($value['vacina_febre_amarela']) ? 'ativo' : '') ?>"><i class="fa-solid fa-syringe"></i></span></td>
                  <td></td>
