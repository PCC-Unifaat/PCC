      ...
      <div class="head">
        <div class="busca w100">
          ...
          <form class="w100" method="post">
            ...
            <div class="btn-busca">
              <a class="limpar-filtro" href="<?php echo INCLUDE_PATH;?>criancas">Limpar filtro</a>
      ...
      <?php }?>
        ...
        <div class="legenda-container">
          ...
          <div class="exportar w50">
            <a href="<?php echo INCLUDE_PATH?>criancas?exportar" class="btn-input" target="_blank">Exportar tabela</a>
          </div>
        </div>
      </div>
