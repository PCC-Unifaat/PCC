...
<div id="painel">
  ...
  <main id="painel-content">
    <div class="container">
      <div class="content">
        <div class="mapa-site">
          <a href="<?php echo INCLUDE_PATH;?>">Painel / </a> <a href="<?php echo INCLUDE_PATH;?>pacientes">Pacientes /</a> <span>Diabéticos</span>
        </div>
      ...
      <div class="head">
        <div class="busca w100">
          ...
          <form class="w100" method="post">
            ...
            <div class="btn-busca">
              <a class="limpar-filtro" href="<?php echo INCLUDE_PATH;?>diabeticos">Limpar filtro</a>
      ...
      <div class="legenda-container">
          ...
          <div class="exportar w50">
            <a href="<?php echo INCLUDE_PATH?>diabeticos?exportar" class="btn-input" target="_blank">Exportar tabela</a>
          </div>
        </div>
      </div>
    </div>
