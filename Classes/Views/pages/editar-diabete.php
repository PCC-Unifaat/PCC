<?php
  $title = 'Editar paciente diabetico';
  $css = ['painel'];
  $js = ['mask','painel','form'];
  include("header.php");
...
<div id="painel">
  ...
  <main id="painel-content">
    <div class="container">
      <div class="content">
        <div class="mapa-site">
          <a href="<?php echo INCLUDE_PATH;?>">Painel / </a> <a href="<?php echo INCLUDE_PATH;?>diabeticos">Diabeticos / </a> <span>Editar paciente diabetico</span>
        </div>
        ...
        <form method="post" enctype="multipart/form-data">
            ...
            <div class="form-single w100">
              <label for="observacao">Observação diabetico: </label>
            ...
            <div class="form-single w100">            
              <input type="submit" class="btn-input" name="editar-diabetico" value="Atualizar!">
            </div> 
        </form>
